...
const Sidebar = () => {
  return (
    <div className="w-full h-full border-r-[1px] border-darkblue/5 font-bold bg-transparent">
      <Link
        to="/"
      ...
      <div className="w-full h-full text-[12px] mt-[30px]">
        <Link
          to="/admin/dashboard"
          className="flex items-center my-[25px] pl-[40px] w-full border-l-[3px] border-transparent hover:border-darkblue transition ease-linear"
        >
